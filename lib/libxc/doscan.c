...
static int _innum(int **ptr, int type, int len, int size, int (*getch)(int, int*),
		  void (*ungetch)(int, int *), int arg1, int *arg2, 
		  int *eofptr);

static int _instr(register char *ptr, int type, int len, int (*getch)(int, int *),
		  void (*ungetch)(int, int *), int arg1, int *arg2, int *eofptr);
